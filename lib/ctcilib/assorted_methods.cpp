...
std::string arrayToString(int* array, int start, int end) {
...
std::string stringArrayToString(String[] array) {
    StringBuilder sb = new StringBuilder();
    for (String v : array) {
        sb.append(v + ", ");
    }
...
std::string toFullBinaryString(int a) {
    String s = "";
    for (int i = 0; i < 32; i++) {
...
std::string toBaseNString(int a, int base) {
...
String listOfPointsToString(ArrayList<Point> list) {
