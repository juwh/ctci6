...
/*
Hints: 
#483. Try approaching this problem recursively.

#579. Suppose you had a method shuffle that worked on decks up to n - 1 elements.
Could you use this method to implement a new shuffle method that works on decks
up to n elements?

#634. You could build this algorithm recursively by swapping the nth element for any of the
