...
/*
Hints: 
#477. Start by grouping the dictionary by the word lengths, since you know each column has
to be the same length and each row has to be the same length.

#500. Can you find a word rectangle of a specific length and width? What if you just tried all
options?
