...
#379. If you fill the 5-quart jug and then use it to fill the 3-quart jug, you'll have two quarts
...
#400. Once you've developed a way to solve this problem, think about it more broadly. If you
