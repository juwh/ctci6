...
#171. You can attempt this mathematically, although the math is pretty difficult. You might
...
#188. Logic might be easier than math. Imagine we wrote every birth into a giant string of Bs
...
#201. Observe that biology hasn't changed; only the conditions under which a family stops
