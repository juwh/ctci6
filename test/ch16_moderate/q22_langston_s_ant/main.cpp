...
#481. Option #1: Do you actually need an infinite grid? Read the problem again. Do you know
the max size of the grid?

#533. Option #2: Think about how an ArrayList works. Can you use an ArrayList for this?

#540. Option #2: It's not impossible to use an ArrayList, but it would be tedious. Perhaps it
would be easier to build your own, but specialized for matrices.

#559. Option #2: One approach is to just double the size of the array when the ant wanders
to an edge. How will you handle the ant wandering into negative coordinates, though?
Arrays can't have negative indices.

#570. Option #2: Observe that nothing in the problem stipulates that the label for the coor-
...
#599 Option #3: Another thing to think about is whether you even need a grid to implement
this. What information do you actually need in the problem?

#616. Option #3: All you actually need is some way of looking up if a cell is white or black (and
of course the position of the ant). Can you just keep a list of all the white cells?

#627. Option #3: You could consider keeping a hash set of all the white cells. How will you be
