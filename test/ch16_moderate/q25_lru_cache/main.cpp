...
/*
Hints: 
#524. First scope the problem. What are the features you would want?

#630. What data structure would be most useful for the lookups? What data structure would
be most useful to know and maintain the order of items?

#694. Both a hash table and a doubly linked list would be useful. Can you combine the two?
*/
#pragma endregion