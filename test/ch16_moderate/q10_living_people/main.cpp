...
#490. Solution 1: Try using a hash table, or an array that maps from a birth year to how many
people are alive in that year.

#507. Solution 2: What if you sorted the years? What would you sort by?

#514. Solution 2: Do you actually need to match the birth years and death years? Does it
matter when a specific person died, or do you just need a list of the years of deaths?

#523. Solution 2: Observe that people are "fungible." lt doesn't matter who was born and when
...
#532. Solution 2: Try creating a sorted list of births and a sorted list of deaths. Can you iterate
through both, tracking the number of people alive at anyone time?

#541. Solution 3: Each birth adds one person and each death removes a person. Try writing an
...
#549. Solution 3: What if you created an array of years and how the population changed in
each year? Could you then find the year with the highest population?

#576. Solution 3: Be careful with the little details in this problem. Does your algorithm/code
