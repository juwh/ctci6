...
#350. Each row must have a queen. Start with the last row. There are eight different columns
on which you can put a queen. Can you try each of these? 

#371. Break this down into smaller subproblems. The queen at row 8 must be at column 1, 2,
