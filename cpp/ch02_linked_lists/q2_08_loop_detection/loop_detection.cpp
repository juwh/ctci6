...
/*
2.8 Loop Detection: Given a circular linked list, implement an algorithm that returns the
...
#69. To identify if there's a cycle, try the "runner" approach described on page 93. Have
one pointer move faster than the other.
...
#90. If you haven't identified the pattern of where the two pointers start, try this: Use
the linked list 1->2->3->4->5->6->7->8->9->?, where the ? links to another node. Try
